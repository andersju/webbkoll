defmodule Webbkoll.Helpers do
  ...
  def headers_to_check do
    %{
      "Strict-Transport-Security" => gettext(
      ...
      "X-Content-Type-Options" => gettext(
